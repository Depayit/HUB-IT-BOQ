/**
 * Sprint 8 Wave 3 — artifact verification
 *
 * Usage: node scripts/verify-s8-wave3-artifacts.mjs
 */
import { readFileSync, statSync, existsSync } from "node:fs";
import path from "node:path";

const WAVE3_ROOT = path.resolve("docs/SPRINT_8/WAVE3");
const REPORT_ROOT = path.join(WAVE3_ROOT, "EXECUTION_REPORT");
...
const REQUIRED_SCRIPTS = [
  "scripts/seed-s8-wave3-scenarios.mjs",
  "scripts/run-s8-wave3-official.mjs",
  "scripts/execute-s8-wave3-official.mjs",
  "scripts/lib/s8-wave3-evidence.mjs",
  "scripts/verify-s8-wave3-artifacts.mjs",
];
...
function checkFinalGreenCheck() {
  const greenPath = path.join(WAVE3_ROOT, "FINAL_GREEN_CHECK.md");
...
function main() {
  console.log("Sprint 8 Wave 3 — Artifact Verification\n");
  checkScripts();
