/**
 * Discipline validation SSOT (S7B-2A).
 *
 * Severity mapping (single source — UI and validation engine both use this module):
 * - BLOCK (mandatory mapping): included discipline with zero BOQ lines (DISCIPLINE_NO_LINES)
 * - BLOCK: invalid risk, duplicate assignment
 * - WARNING (optional/minor): missing scope text when lines exist (DISCIPLINE_MISSING_SCOPE)
 * - WARNING: critical risk without assessment in scope (DISCIPLINE_CRITICAL_NO_RISK)
 */
